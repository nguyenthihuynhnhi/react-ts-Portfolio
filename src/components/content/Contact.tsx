      ...
      <div className="arlo_tm_section" id="contact">
        ...
        <div className="arlo_tm_footer_contact_wrapper_all">
                  ...
                  <ul>
                    <li>
                      <p>
                        <label>Email:</label>
                        <span>
                          <a href="mailto:huynhnhinguyen@gmail.com">huynhnhinguyen@gmail.com</a>
                        </span>
                      </p>
                    </li>
                    <li>
                      <p>
                        <label>Website:</label>
                        <span>
                          <a href="http://hoidanit.com.vn" target='_blank'>www.yourdomain.com</a>
                        </span>
                      </p>
                    </li>
                  </ul>
          ...
          <div className="arlo_tm_footer_wrap">
            <div className="container">
              <p>&copy; Copyright 2023 by NGUYEN THI HUYNH NHI. All Rights are Reserved.</p>
            </div>
          </div>
        </div>
      </div>
